...
export const Command = {
  ...
  run: async (client, interaction) => {
    ...
    try {
     ...
     if(!vc) return interaction.reply({ content: "Please join a vc first", ephemeral: true })

      if(!song) return interaction.reply({ content: "Please provide a song", ephemeral: true })
