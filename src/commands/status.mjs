...
[Memory]:
    Allocated: ${(node.stats.memory.allocated / 1024 ** 2).toFixed(2)}MB
    Used: ${(node.stats.memory.used / 1024 ** 2).toFixed(2)}MB
    Free: ${(node.stats.memory.free / 1024 ** 2).toFixed(2)}MB
    Reserved: ${(node.stats.memory.reservable / 1024 ** 2).toFixed(2)}MB
[CPU]:
...
[Bot Memory]:
    Allocated: ${(os.totalmem() / 1024 ** 2).toFixed(2)}MB
    Used: ${(process.memoryUsage().heapTotal / 1024 ** 2).toFixed(2)}MB
    Free: ${(os.freemem() / 1024 ** 2).toFixed(2)}MB
    Reserved: ${(process.memoryUsage().rss / 1024 ** 2).toFixed(2)}MB
[CPU]:
